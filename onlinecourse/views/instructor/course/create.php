...
<div class="container course-form">
    ...
    <form method="post" action="index.php?controller=instructor&action=createCourse" class="form">
        <div class="form-group">
            <label for="title">Tiêu đề <span class="required">*</span></label>
            <input type="text" id="title" name="title" required placeholder="Nhập tiêu đề khóa học">
        </div>

        <div class="form-group">
            <label for="description">Mô tả <span class="required">*</span></label>
            <textarea id="description" name="description" required rows="6" placeholder="Nhập mô tả khóa học"></textarea>
        </div>
